 ...
 <?php get_header(); ?>
	...
	<div class="container">
		...
		<div id="owl-demo" class="owl-carousel owl-theme row">
		  ...
		  <div class="item"><img src="<?php bloginfo('template_url' ); ?>/img/banners1.jpg" alt="Banner1"></div>
		 
		  <div class="item"><img src="<?php bloginfo('template_url' ); ?>/img/banners2.jpg" alt="Banner1"></div>

		  <div class="item"><img src="<?php bloginfo('template_url' ); ?>/img/banners3.jpg" alt="Banner1"></div>
